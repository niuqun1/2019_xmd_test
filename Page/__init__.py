...
# 相机快门
xjkm=(By.XPATH,"//GLButton[@resource-id='NONE' and @text='快门' and @content-desc='NONE']")
# 选择照片
gouzp=(By.XPATH,"//android.widget.TextView[@resource-id='com.sec.android.app.camera:id/okay' and @text='确定']")
# 定位按钮
xxdz=(By.XPATH,"dget.LinearLayout[4]/android.widget.LinearLayout[1]/android.widget.RelativeLayout[1]/android.widget.ImageView[1]")
# 选择位置
...
cx4=(By.XPATH,"//android.widget.TextView[@resource-id='com.kanche.mars:id/tv_title' and @text='2015款 535i xDrive 3.0T 手自一体 M运动型']")
# 表显里数
